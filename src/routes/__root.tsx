...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zentrix Software Solutions — Every software problem, solved." },
      { name: "description", content: "Zentrix Software Solutions is a premium software engineering studio building web, mobile, cloud, and AI systems for businesses and founders." },
      { name: "author", content: "Zentrix Software Solutions" },
